...
using System.Data;
using niceadmintheme.Areas.LOC_City.Models;
using niceadmintheme.Areas.LOC_State.Models;
using niceadmintheme.Areas.LOC_Country.Models;

namespace niceadmintheme.Areas.LOC_City.Controllers
{
    [Area("LOC_City")]
    ...
    public class LOC_CityController : Controller
    {
        ...
        {
            string myconnStr1 = this.Configuration.GetConnectionString("MyConnectionStr");
